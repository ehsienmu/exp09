...
def main(args):
    ...
    train_dataset = CIFAR10(root='../train', train=True, transform=transform_train, download=True)
    val_dataset = CIFAR10(root='../test', train=False, transform=transform_test, download=True)

    # train_dataset = ImageFolder(train_dir,transform = transform_train,backend = 'opencv')
